...
tf.app.flags.DEFINE_string('checkpoint', 'models/x3/ckpt-00754300',
                            """Path to model checkpoint.""")
tf.app.flags.DEFINE_string('inference_graph', 'models/x3/inference.pbtxt',
                            """Path to model inference_graph def.""")
tf.app.flags.DEFINE_string('image_path', 'T91/t1.png',
